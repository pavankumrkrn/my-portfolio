        ...
        <div className="mt-5">
            ...
            <div className="row mt-5">
                ...
                <div className="col-5 text-white text-left" data-aos='fade-left'>
                    <p className="text">Java Developer</p>
            ...
            <div className="row m-5">
                <div className="col-sm-12 m-auto" data-aos='fade-up'>
                    <p className="text-left text-white text">
                        As a Java developer my roles and responsibilities are to design, develop, and maintain java application.
